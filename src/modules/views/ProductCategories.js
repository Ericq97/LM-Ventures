...
const handleButtonClick_google = () => {
    window.open('https://www.google.com', '_blank');
  };
  const handleButtonClick_bing = () => {
...
const images = [
  {
    ...
    website: handleButtonClick_google,
    title: 'Snorkeling',
    width: '40%',
  },
  {
    url: 'https://images.unsplash.com/photo-1531299204812-e6d44d9a185c?auto=format&fit=crop&w=400',
    website: handleButtonClick_bing,
    title: 'Massage',
    width: '20%',
  },
  {
...
export default function ProductCategories() {
  return (
    <Container id="hero" component="section" sx={{ mt: 8, mb: 4 }}>
      ...
      <Box sx={{ mt: 8, display: 'flex', flexWrap: 'wrap' }}>
        {images.map((image) => (
          <ImageIconButton
          onClick={image.website} aria-label="External Link"
            key={image.title}
            style={{
              width: image.width,
            }}
